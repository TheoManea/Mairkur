...
class EditEvent extends React.Component {
    ...
    onSubmit() {
        ...
        fetch('http://mairkurapi.eu-west-3.elasticbeanstalk.com/api/events/edit', { method: 'PUT', headers: {'Content-Type': 'application/json', 'Accept': 'application/json', 'Authorization': 'Bearer ' + this.props.route.params.token}, body: JSON.stringify({userId: this.props.route.params.idCreator, title: this.state.title, details: this.state.des, id: this.props.route.params.event.id, idAssos: this.props.route.params.event.idAssos, dayStartEvent: this.props.route.params.event.dayStartEvent, dayEndEvent: this.props.route.params.event.dayEndEvent}) })
